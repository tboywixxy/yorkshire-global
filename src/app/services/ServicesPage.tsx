    ...
    () => [
      {
        ...
        outcome: "Stronger applications built with security at their core.",
      },
      {
      ...
      },
      {
        ...
        outcome: "Greater clarity, reduced rework, and smoother execution.",
      },
      {
...
<section className="-mt-14" aria-label="Services hero">
  <div className="relative left-1/2 w-screen -translate-x-1/2 overflow-hidden">
    <div className="relative h-[44vh] min-h-[360px] w-full">
      <Image
        src="https://images.unsplash.com/photo-1629904869753-e8cb289490bd?auto=format&fit=crop&w=2400&q=80"
        alt="Services hero background"
        fill
        priority
        sizes="100vw"
        className="object-cover object-[center_15%]" // ✅ move image UP
      />
            ...
            <aside className="lg:col-span-4">
              <div className="border border-[rgb(var(--border))] bg-[rgb(var(--card))] shadow-sm">
                <div className="border-b border-[rgb(var(--border))] p-5">
                  <p className="text-sm font-semibold text-[rgb(var(--foreground))]">Service Areas</p>
                  <p className="mt-1 text-sm text-[rgb(var(--muted))]">Select a service to view details.</p>
                </div>
              ...
              <div className="relative border border-[rgb(var(--border))] bg-[rgb(var(--card))] shadow-sm overflow-hidden">
                <div className="border-b border-[rgb(var(--border))] p-6 sm:p-8">
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <span className="text-xs text-[rgb(var(--muted))]">Security-first • Execution-focused</span>
                  </div>
                ...
                <div className="p-6 sm:p-8">
                  <div className="border-l-2 border-[rgb(var(--border))] pl-4">
                    <p className="text-xs font-semibold text-[rgb(var(--muted))]">Expected Outcome</p>
