...
export default function ServicesPage() {
  ...
  // 1s loading spinner when switching services
  ...
  return (
    <>
      {/* ✅ Top hero image (like About page) */}
      <section className="-mt-14">
        ...
        {/* ✅ Content area with your “alive” disruptive background */}
        <section className="relative overflow-hidden pt-12 pb-16 sm:pt-14 sm:pb-20">
              ...
              <div className="lg:col-span-8">
                <div className="relative border border-[rgb(var(--border))] bg-[rgb(var(--card))] shadow-sm overflow-hidden">
                  <div className="border-b border-[rgb(var(--border))] p-6 sm:p-8">
                    ...
                    <h3 className="mt-3 text-xl font-semibold tracking-tight text-[rgb(var(--foreground))] sm:text-2xl">
                      {active.title}
                    </h3>
                ...
                {/* highlights centered + icons under heading */}
                <div className="mt-6 grid gap-4 sm:grid-cols-3">
                  {[
                    ...
                    >
                      ...
                      <div className="mt-3 text-[rgb(var(--foreground))] opacity-85">
                        {x.icon}
                      </div>
